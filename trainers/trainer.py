...
class Trainer:
    ...
    def train(
        ...
        **kwargs,
        ...
        # for total_step in range(epochs_trained * len(train_dataloader), num_train_epochs * len(train_dataloader)):
        ...
        #     self.train_step()
        #
        #     if (total_step + 1) // update_freq:
        #         update
        #         update_dataloader_flag = True
        #
        #     if (total_step + 1) //  len(train_dataloader):  # epoch end
        #         xxxxx
