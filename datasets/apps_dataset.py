    ...
    def initialize(self):
        ...
        for problem_name in tqdm(self.problem_dirs):
            if self.tuning_mode in ['critic']:                
                gen_sols_fname = [os.path.join(self.dataroot, problem_name, "gen_solutions_4.json")]

            elif self.tuning_mode in ['rl']:
                gen_sols_fname = [os.path.join(self.dataroot, problem_name, "gen_solutions_critic_scores_4.pkl")]
                
                if self.relative_returns: 
                    baseline_fname = os.path.join(self.dataroot, problem_name, "baseline_solutions_4.json")
